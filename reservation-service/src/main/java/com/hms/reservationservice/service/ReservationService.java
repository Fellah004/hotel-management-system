...
public interface ReservationService {
    ...
    ReservationResponse confirmReservation(Long id, Long currentUserId, String currentUserRole);
    ...
    RateQuoteResponseDto getPriceBreakdown(Long id, Long currentUserId, String currentUserRole);
    RateQuoteResponseDto previewQuote(CreateReservationRequest request);
