...
import com.hms.reservationservice.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleForbidden(Exception ex, HttpServletRequest request) {
        ...
        ErrorResponse error = ErrorResponse.builder()
                ...
                .error("FORBIDDEN")
                .message("Access denied: Insufficient privileges to perform this reservation operation")
                .path(request.getRequestURI())
                .traceId(getTraceId())
                .build();
    ...
    public ResponseEntity<ErrorResponse> handleHttpMessageNotReadable(org.springframework.http.converter.HttpMessageNotReadableException ex, HttpServletRequest request) {
        log.warn("Malformed JSON request in reservation-service: {}", ex.getMessage());
        String msg = "Malformed JSON request payload or invalid data format";
    ...
    public ResponseEntity<ErrorResponse> handleGeneral(Exception ex, HttpServletRequest request) {
        log.error("Unhandled exception in reservation-service: ", ex);
        ErrorResponse error = ErrorResponse.builder()
                .timestamp(LocalDateTime.now())
