...
class PurchaseServiceTest {
    ...
    @Test
    void createPurchaseOrder_BlacklistedSupplier_ThrowsBusinessRuleException() {
        Supplier blacklisted = Supplier.builder()
                .id(2L)
                .name("Bad Supplier")
        ...
        when(supplierRepository.findById(2L)).thenReturn(Optional.of(blacklisted));

        assertThrows(BusinessRuleException.class, () -> purchaseService.createPurchaseOrder(request, 1L));
    }

    @Test
    void createPurchaseOrder_InactiveSupplier_ThrowsBusinessRuleException() {
        Supplier inactive = Supplier.builder()
                .id(3L)
        ...
        when(supplierRepository.findById(3L)).thenReturn(Optional.of(inactive));
