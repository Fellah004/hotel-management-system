...
public class PurchaseEventConsumer {
    ...
    public void handleLowStockEvent(EventEnvelope<Map<String, Object>> event) {
        ...
        try {
            ...
            Object minThresholdObj = payload.get("minimumThreshold") != null ? payload.get("minimumThreshold") : payload.get("minThreshold");
            Object departmentIdObj = payload.get("departmentId");
            Object requesterIdObj = payload.get("requesterId");
            ...
            if (itemIdObj != null) {
                ...
                Long departmentId = departmentIdObj != null ? Long.valueOf(departmentIdObj.toString()) : 1L;
                Long requesterId = requesterIdObj != null ? Long.valueOf(requesterIdObj.toString()) : 1L;
                String unit = unitObj != null ? unitObj.toString() : "UNITS";
                ...
                purchaseService.createPurchaseRequest(prRequest, requesterId, "SYSTEM");
